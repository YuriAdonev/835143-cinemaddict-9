export const createFilmDetailsTemplate = ({poster, title, age, titleOriginal, rating, director, writers, actors, releaseDate, duration, country, description, isWatchlist, isFavorites, isWatched, comments, genres}) => `
      ...
      <div class="form-details__bottom-container">
        <section class="film-details__comments-wrap">
          ...
          <ul class="film-details__comments-list">
            ${Array.from(comments).map(({emoji, text, author, date}) => `
